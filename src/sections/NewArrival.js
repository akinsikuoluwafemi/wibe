...
const Overlay = styled.div`
  ...
  box-shadow: 0 0 0 4vw ${(props) => props.theme.dark.text};
  border: 3px solid ${(props) => props.theme.dark.body};
  z-index: 11;
`;
...
const Title = styled.h1`
  ...
  font-weight: 300;
  text-shadow: 1px 1px 1px ${(props) => props.theme.dark.text};
  color: ${(props) => props.theme.dark.body};
  position: absolute;
  top: 1rem;
  left: 5%;
  z-index: 11;
  ...
  useLayoutEffect(() => {
    ...
    setTimeout(() => {
      t1.to(element, {
        ...
        // we have to increase scrolling height of this section to the same as the scrolling element width
        ease: "none",
      });
